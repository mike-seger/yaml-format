...
public class YamlFormatterTest implements ResourceLoader {
	...
	public void testIdentityYaml(String expected, String actual) throws IOException, URISyntaxException {
	...
	public void testFormatYamlFail() {
		Exception thrown = assertThrows(IllegalStateException.class, () -> yamlFormatter.format(fromResource("merge1-fail.yaml")));
	...
	public void testFormatYamlFailMerge() {
		Exception thrown = assertThrows(IllegalStateException.class, () -> yamlFormatter.format(fromResource("merge2-fail.yaml")));
	...
	public void testValidIssue() {
		Exception thrown = assertThrows(ConstructorException.class, () -> yamlFormatter.format(fromResource("issue-merge-valid.yaml")));
		assertLinesMatch(List.of("Can't construct a java object for tag:yaml.org,2002:java.util.HashMap.*"),
